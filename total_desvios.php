...
<body>
    ...
    <table border="1">
        ...
        <tbody>
            ...
            {?>
            <tr>
                <td><?php echo $desvio_i['id_desvio']; ?></td>
                <td><?php echo $desvio_i['data_identificacao']; ?></td>
                <td><?php echo $desvio_i['tipo_desvio']; ?></td>
                <td><?php echo $desvio_i['gravidade']; ?></td>
                <td><?php echo $desvio_i['setor']; ?></td>
            </tr>
            <?php $x++;} ?>
        </tbody>
    </table>
