...
$sql_desvios_setor_cremes = "SELECT id_desvio, tipo_desvio, gravidade, setor FROM tabela_desvio WHERE setor = 3"; // Aqui usei o ID do setor Cremes (3) para a consulta
