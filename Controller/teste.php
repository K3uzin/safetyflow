        ...
        //teste de get_all_resolucao
            ...
            //cenario de sucesso
                ...
                while($x < $t){
                    ...
                    $resolucao_i = $data[$x];
                    echo 'id_resolução: '.$resolucao_i['idresolucao'].'<br>';
                    ...
                    echo 'area responsavel: '.$resolucao_i['id_area_r'].'<br>';
                    ...
                    echo 'graviade do desvio: '.$desvio_data->get_gravidade().'<br>';
