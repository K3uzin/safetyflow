...
class feedback{
    ...
    public function update_feedback($usuario,$nota,$comentario,$conexao){
        ...
        $data_postagem = date('Y-m-d');
        $query = "UPDATE feedback set nota = $nota, comentario = '$comentario', data_postagem = '$data_postagem' Where usuario_matricula = '$usuario'";
        $result = $conexao->query($query);
    ...
    public function get_data_postagem(){
